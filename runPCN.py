...
from models.pcn import PCNMLPModule, PCNModule, PCNTreeModule
...
module_dict = {"pcn": PCNModule, "pcnmlp": PCNMLPModule, "pcntree": PCNTreeModule}
...
def get_args():
    ...
    parser.add_argument("--module", type=str, default="pcn", help="Module to use")
    ...
    parser.add_argument("--save_iter", type=int, default=1000, help="Save interval")
...
if __name__ == "__main__":
    ...
    train_loader, test_loader, val_loader = dataLoaders(
        args, num_workers=32, prefetch_factor=128
    )
