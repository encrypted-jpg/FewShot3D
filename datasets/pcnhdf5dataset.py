...
class PCNImageHDF5Dataset(data.Dataset):
    def __init__(self, folder, jsonfile, hdf5_file="dataset.h5", transform=None, mode='train', b_tag="depth", img_height=224, img_width=224, img_count=3):
    ...
    def get_img(self, idx, img_num):
        group_key = f'{self.file_list[idx]["taxonomy_id"]}-{self.file_list[idx]["model_id"]}'
    ...
    def __getitem__(self, idx):
        ...
        return taxonomy_id, model_id, (img, pc, pc)
